...
from app.core.dependencies import get_researcher_agent, get_writer_agent
from app.agents.researcher import research_query
from app.agents.writer import write_response
...
async def process_query(
    ...
    try:
        ...
        final_response = await write_response(
